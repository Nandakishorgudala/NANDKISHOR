...
import { BranchPerformance } from '../../../services/agent.service';

@Component({
  selector: 'app-chart-branch-performance',
  standalone: true,
    ...
    <div class="chart-widget">
      <div class="chart-header">
        <div class="title-group">
          ...
          <p class="chart-subtitle">Regional premium and volume comparison</p>
        </div>
      </div>
...
export class ChartBranchPerformanceComponent implements OnChanges {
  @Input() data?: BranchPerformance;
